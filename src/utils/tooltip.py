# source: https://github.com/jessielw/Custom-Tkinter-Tooltip
...
class CustomTooltipLabel(CustomToolTipBase):
    ...
    def configure(self, **kwargs):
        ...
        # If the tooltip is currently visible, update it
        if self.label:
            self.label.configure(**kwargs)
        
        # If hover_delay is changed, update it in the parent class
        if 'hover_delay' in kwargs:
            self.hover_delay = kwargs['hover_delay']
